        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Manifestacija = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Karta_AspNetUsers_Korisnik",
                        column: x => x.Korisnik,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDMjesta = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Karta = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KupljenaMjesta_Karta_Karta",
                        column: x => x.Karta,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Karta_Korisnik",
                table: "Karta",
                column: "Korisnik");

            migrationBuilder.CreateIndex(
                name: "IX_Karta_Manifestacija",
                table: "Karta",
                column: "Manifestacija");

            migrationBuilder.CreateIndex(
                name: "IX_KupljenaMjesta_Karta",
                table: "KupljenaMjesta",
                column: "Karta");
        }

...
namespace OnlineProdajaKarata.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Datum Rodjenja is not in the correct format. Please use 'dd.MM.yyyy'.");
                    return Page();
                }
